...
def xgboostModel():
    ...
    arquivos = [f for f in os.listdir(INPUT_FOLDER) if 'MSFT' in f and f.endswith('.csv')]
    ...
    plt.tight_layout()
    plt.savefig('./3-modelos-especialistas/MSFT/matriz-MSFT-3-classes.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'matriz-MSFT-3-classes.png'")
