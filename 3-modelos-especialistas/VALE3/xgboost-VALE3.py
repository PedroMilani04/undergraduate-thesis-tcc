...
def xgboostModel():
    ...
    arquivos = [f for f in os.listdir(INPUT_FOLDER) if 'VALE3' in f and f.endswith('.csv')]
    ...
    plt.tight_layout()
    plt.savefig('./3-modelos-especialistas/VALE3/matriz-VALE3-3-classes.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'matriz-VALE3-3-classes.png'")
