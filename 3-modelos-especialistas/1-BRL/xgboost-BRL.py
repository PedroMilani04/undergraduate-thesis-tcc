...
def xgboostModel():
    ...
    arquivos = ['ABEV3.SA_rotulado.csv', 'BBDC4.SA_rotulado.csv', 'ITUB4.SA_rotulado.csv', 'PETR4.SA_rotulado.csv', 'VALE3.SA_rotulado.csv']
    ...
    plt.tight_layout()
    plt.savefig('./3-modelos-especialistas/1-BRL/matriz-BRL-3-classes.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'matriz-BRL-3-classes.png'")
