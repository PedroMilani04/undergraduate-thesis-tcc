...
def xgboostModel():
    ...
    arquivos = ['ABEV3.SA_rotulado.csv', 'ITUB4.SA_rotulado.csv', 'PETR4.SA_rotulado.csv', 'VALE3.SA_rotulado.csv', 'BBDC4.SA_rotulado.csv']
    ...
    plt.tight_layout()
    plt.savefig('./3-modelos-especialistas/1-BRL/BRL-3-classes-9.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'BRL-3-classes-9.png'")
    ...
    export_path = './3-modelos-especialistas/1-BRL/BRL_baseline_3_classes.csv'
