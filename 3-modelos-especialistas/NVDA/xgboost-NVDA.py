...
def xgboostModel():
    ...
    arquivos = [f for f in os.listdir(INPUT_FOLDER) if 'NVDA' in f and f.endswith('.csv')]
    ...
    plt.tight_layout()
    plt.savefig('./3-modelos-especialistas/NVDA/matriz-NVDA-3-classes.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'matriz-NVDA-3-classes.png'")
