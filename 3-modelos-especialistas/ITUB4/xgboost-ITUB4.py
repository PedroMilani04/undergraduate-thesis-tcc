...
def xgboostModel():
    ...
    arquivos = [f for f in os.listdir(INPUT_FOLDER) if 'ITUB4' in f and f.endswith('.csv')]
    ...
    plt.tight_layout()
    plt.savefig('./3-modelos-especialistas/ITUB4/matriz-ITUB4-3-classes.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'matriz-ITUB4-3-classes.png'")
