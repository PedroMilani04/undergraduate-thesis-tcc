...
def xgboostModel():
    ...
    arquivos = [f for f in os.listdir(INPUT_FOLDER) if 'PETR4' in f and f.endswith('.csv')]
    ...
    plt.tight_layout()
    plt.savefig('./3-modelos-especialistas/PETR4/matriz-PETR4-3-classes.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'matriz-PETR4-3-classes.png'")
