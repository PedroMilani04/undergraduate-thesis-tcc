...
def xgboostModel():
    ...
    arquivos = [f for f in os.listdir(INPUT_FOLDER) if 'AAPL' in f and f.endswith('.csv')]
    ...
    plt.tight_layout()
    plt.savefig('./3-modelos-especialistas/AAPL/matriz-AAPL-3-classes.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'matriz-AAPL-3-classes.png'")
