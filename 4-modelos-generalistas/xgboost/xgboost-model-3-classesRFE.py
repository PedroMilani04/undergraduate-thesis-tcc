...
def xgboostModel():
    ...
    plt.tight_layout()
    plt.savefig('./4-modelos-generalistas/xgboost/eleicoes/TAXAS+RFE-matriz-baseline-3-classes-3prova.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'TAXAS+RFE-matriz-baseline-3-classes-3prova.png'")
