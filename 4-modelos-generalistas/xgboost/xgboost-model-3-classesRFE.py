...
def xgboostModel():
    ...
    plt.tight_layout()
    plt.savefig('./4-modelos-generalistas/xgboost/vix/VIX-matriz-baseline-3-classes-15.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'VIX-matriz-baseline-3-classes-15.png'")
    ...
    export_path = './4-modelos-generalistas/xgboost/vix/RFE-features_treino_teste_3_classes.csv'
