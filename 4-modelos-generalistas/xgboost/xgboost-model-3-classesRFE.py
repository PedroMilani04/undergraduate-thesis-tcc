...
def xgboostModel():
    ...
    plt.tight_layout()
    os.makedirs('./4-modelos-generalistas/xgboost/bitcoin', exist_ok=True)
    plt.savefig('./4-modelos-generalistas/xgboost/bitcoin/RFE-matriz-baseline-3-classes-9features.png', dpi=300)
    print("\n[SUCESSO] Imagem salva como: 'bitcoin/RFE-matriz-baseline-3-classes-9features.png'")
    ...
    export_path = './4-modelos-generalistas/xgboost/bitcoin/RFE-features_treino_teste_3_classes-9features.csv'
